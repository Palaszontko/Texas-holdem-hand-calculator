...
<div class="p-4 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 shadow-2xl w-full">
    <div class="flex flex-col lg:flex-row gap-8">

        <div class="flex flex-col sm:flex-row justify-center gap-8">
            <div class="flex flex-col items-center">
                <div class="text-white text-lg md:text-xl mb-2">{positions.player.name}</div>
            ...
            <div class="flex flex-col items-center">
                <div class="text-white text-lg md:text-xl mb-2">{positions.opponent.name}</div>
                <div class="flex gap-2">
        ...
        <div class="flex flex-col items-center">
            <div class="text-white text-lg md:text-xl mb-2">{positions.board.name}</div>
